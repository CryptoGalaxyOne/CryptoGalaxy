<template>
  <div class="Android-Download">
    <div class="box">
        <div class="close-box" @click="$emit('openAndroid',false)">
      ...
      <div class="my-bd">
        ...
        <a
          class="link"
          href="http://cdn.zeepin.io/cryptogalaxy/CG_2.1.1_intl.apk"
        >{{$t("banner.prompt4")}}</a>
      <!--   <p class="prompt">{{$t("banner.prompt2")}}</p>
        <a
          class="link"
          href="http://cdn.zeepin.io/cryptogalaxy/CG_2.1.1_apc.apk"
        >{{$t("banner.prompt4")}}</a> -->
      </div>
    </div>
  </div>
