<template>
  <div class="page">
    ...
    <div class="hd">
      ...
      <div class="version">Beta 1.5.0</div>
    ...
    <div class="bd">
      ...
      <a class="link" :class="{doing: doing}" @click="download" href="http://aq.pgyer.com/e1428f826dedecbcd7a554a34383653d.ipa?attname=CSR201808030424XSXARX-resigned.ipa">Install iOS App</a>
    </div>
...
@media only screen and (min-width: 751px) {
  ...
  .page {
    position: relative;
    width: 100%;
    background: url("@{imgPath}/download-bg.jpg") no-repeat center center ~"/" cover;
    .hd {
      padding-top: 160/@unit;
      .logo {
        width: 230 / @unit;
        height: 230 / @unit;
        display: block;
        margin: 0 auto 25 / @unit;
      }
      .title {
        font-weight: 500;
        font-size: 40 / @unit;
      ...
      .link {
        ...
        &.doing {
          ...
          &::after {
            ...
            width: 36 / @unit;
            height: 36 / @unit;
            border: 4 / @unit solid rgba(0, 0, 0, 0);
